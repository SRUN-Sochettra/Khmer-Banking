...
The following versions of Khmer Banking are currently being supported with security updates.
...
You should receive a response within 48 hours. If the issue is confirmed, we will release a fix as soon as possible.
